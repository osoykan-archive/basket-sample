...
namespace BasketContext.Framework
{
	[Serializable]
	...
	public class AggregateRoot<TPrimaryKey> : IAggregateRoot<TPrimaryKey>
	{
		...
		/// </returns>
		public virtual bool HasChanges() => _recorder.Any();
		...
		public virtual IEnumerable<object> GetChanges() => _recorder.ToArray();
		...
		protected virtual void ApplyChange(object @event)
		{
			if (@event == null)
			{
